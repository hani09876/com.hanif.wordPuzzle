...
func _on_Timer_timeout():
	if i != star:
		i = i + 1
		match i:
			1:popup($Win/Winstar1)
			2:popup($Win/Winstar2)
			3:popup($Win/Winstar3)
	match star:
		1:
			$Win/Good.texture = preload("res://images/logo/bad.png")
		2:
			$Win/Good.texture = preload("res://images/logo/good.png")
		3:
			$Win/Good.texture = preload("res://images/logo/super.png")
	popup($Win/Good)
